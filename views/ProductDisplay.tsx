...
import { Search, Loader2, Save, MapPin, Calendar } from 'lucide-react';
        ...
        <div className="space-y-6 max-w-3xl mx-auto animate-fade-in-up">
            ...
            <div className="p-6 bg-surface dark:bg-dark-surface rounded-lg shadow-md border border-border dark:border-dark-border space-y-6">
                ...
                <div>
                    ...
                    <input type="text" value={productName} onChange={e => setProductName(e.target.value)} className="w-full py-2 px-3 bg-transparent border border-border dark:border-dark-border rounded-md" />
                </div>
