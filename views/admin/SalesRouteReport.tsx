...
import { Seller, Customer, District, SalesRouteReportItem } from '../../types';
...
const SalesRouteReport: React.FC = () => {
    ...
    useEffect(() => {
        const fetchFilters = async () => {
             ...
             try {
                const [sellersRes, customersRes, districtsRes] = await Promise.all([
    ...
    }, [startDate, endDate, selectedSellerId, selectedCustomerId, selectedDistrictId, selectedStatus, pagePermissions, showNotification]);
