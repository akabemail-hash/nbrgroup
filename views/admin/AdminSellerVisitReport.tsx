...
import { SellerVisit, Customer, Seller, ProductGroup } from '../../types';
import { Loader2, ChevronLeft, ChevronRight, Image as ImageIcon, X, ChevronDown, CheckSquare, Square, Tag, Layers } from 'lucide-react';
...
const AdminSellerVisitReport: React.FC = () => {
    ...
    const fetchReports = useCallback(async () => {
        ...
        try {
            ...
            if (sellers.length === 0 || customers.length === 0 || productGroups.length === 0) {
                ...
                const [{ data: sellersData }, { data: customersData }, { data: groupsData }] = await Promise.all([sellersPromise, customersPromise, groupsPromise]);
    ...
    }, [pagePermissions, showNotification, sellers.length, customers.length, productGroups.length, currentPage, filters]);
